...
ActiveRecord::Schema.define(version: 2021_08_23_143713) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["job_seeker_id"], name: "index_users_on_job_seeker_id"
  ...
  add_foreign_key "users", "job_seekers"
  add_foreign_key "users", "recruiters"
end
